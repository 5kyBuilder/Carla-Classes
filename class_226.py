                ...
                if isinstance(self._control, carla.VehicleControl):
                    if event.key == K_q:
                        ...
                        if not self._lights & carla.VehicleLightState.Position:
                            ...
                            print("3:", current_lights)
                        else:
                            world.hud.notification("Low beam lights")
                            current_lights |= carla.VehicleLightState.LowBeam
                            print("4:", current_lights)
                        if self._lights & carla.VehicleLightState.LowBeam:
                            world.hud.notification("Fog lights")
                            current_lights |= carla.VehicleLightState.Fog
                            print("5:", current_lights)
    ...
    def tick(self, world, clock):
        ...
        if len(vehicles) > 1:
            ...
            for d, vehicle in sorted(vehicles, key=lambda vehicles: vehicles[0]):
                ...
                # print("vehicle type:",self._info_text)
...
def game_loop(args):
    ...
    try:
        ...
        # print(store_driving_data)
        # field_names = ['brake','hand_brake','throttle','right','left']
        # csvfilestore = open('Names13.csv', 'w', newline='')
