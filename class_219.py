...
def sematic_lidar_data(point_cloud_data):
    distance_name_data = {}
    ...
    for detection in point_cloud_data:
        ...
        print("Name of object: ", distance_name_data["name"], ", Distance of Object: ", distance_name_data["distance"]) 
...
try:
    ...
    sensor.listen(lambda point_cloud_data: sematic_lidar_data(point_cloud_data))
    car_control()
